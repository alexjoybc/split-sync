...
import { Alert, Animated, FlatList, Pressable, ScrollView, StatusBar, StyleSheet, Text, TextInput, useWindowDimensions, View } from "react-native";
...
const colors = {
  paper:       palette.paper,
  panel:       palette.panel,
  white:       '#FFFFFF',           // pure white — for text/borders on dark surfaces
  ink:         palette.ink,
  muted:       palette.muted,
  red:         palette.red,
...
function Button({ title, onPress, variant = "dark", disabled = false }: { title: string; onPress: () => void; variant?: "dark" | "red" | "yellow" | "outline" | "blue"; disabled?: boolean }) {
        ...
        <ScrollView contentContainerStyle={styles.content}>
          <View style={styles.statusRow}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
              <Animated.View style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: colors.pulseColor, opacity: pulseAnim }} />
          ...
          {/* ON COURSE */}
          <View style={[styles.ttSectionBox, { backgroundColor: ttRunningEntries.length > 0 ? colors.ink : colors.ttSection }, ttRunningEntries.length > 0 && { shadowColor: colors.red, shadowOpacity: 0.32, shadowRadius: 14, shadowOffset: { width: 0, height: 0 }, elevation: 8 }]}>
...
const styles = StyleSheet.create({
  ...
  // Time trial styles
  // rgba(0,0,0,0.85): full-screen countdown overlay — semi-opaque black scrim over the live view
  ...
  ttCountdownNumber: { fontSize: 120, fontWeight: "700", fontFamily: "BarlowCondensed_700Bold", fontVariant: ["tabular-nums"], color: colors.yellow, lineHeight: 140 },
  ttCancelBtn: { marginTop: 32, borderWidth: 2, borderColor: colors.white, paddingHorizontal: 28, paddingVertical: 14 },
  ttCancelBtnText: { color: colors.white, fontSize: 13, fontWeight: "900", letterSpacing: 1 },
  ...
  ttRunnerBib: { color: colors.yellow, fontSize: 52, fontWeight: "700", fontFamily: "BarlowCondensed_700Bold", fontVariant: ["tabular-nums"], letterSpacing: -0.2, lineHeight: 60 },
  ttRunnerName: { color: colors.white, fontSize: 20, fontWeight: "900", textTransform: "uppercase", marginBottom: 8 },
  ttElapsed: { color: colors.white, fontSize: 38, fontWeight: "700", fontFamily: "BarlowCondensed_700Bold", fontVariant: ["tabular-nums"], letterSpacing: 2, marginBottom: 10 },
  // rgba(255,255,255,0.2): faint white progress bar track on the dark ink panel
  ...
  ttQueueBib: { color: colors.ink, fontSize: 20, fontWeight: "700", fontFamily: "BarlowCondensed_700Bold", fontVariant: ["tabular-nums"], letterSpacing: -0.2, minWidth: 52 },
  ...
  // rgba(255,255,255,0.2): subtle divider between runner cards on the dark ink panel
