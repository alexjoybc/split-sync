  ...
  return (
    <main className="race-page">
      ...
      <div className="mx-auto max-w-3xl px-4 pt-8 sm:px-6">
        <div className="race-section-heading"><p className="race-kicker--muted">Race calendar</p><h2 className="mt-1 text-2xl font-black uppercase">Events</h2></div>
